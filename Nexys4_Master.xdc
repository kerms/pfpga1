...
set_property PACKAGE_PIN E16 [get_ports button[2]]						
	set_property IOSTANDARD LVCMOS33 [get_ports button[2]]
##Bank = 15, Pin name = IO_L14P_T2_SRCC_15,					Sch name = BTNU
set_property PACKAGE_PIN F15 [get_ports button[0]]							
...
set_property PACKAGE_PIN V10 [get_ports button[4]]						
...
set_property PACKAGE_PIN G13 [get_ports dcc_out]					
	set_property IOSTANDARD LVCMOS33 [get_ports dcc_out]
